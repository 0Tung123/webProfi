...
export default function Footer() {
  return (
    <footer className="border-t border-[var(--surface-border)] py-12 md:py-16">
      <div className="mx-auto w-full max-w-[1920px] px-6">
        <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-8">
          {/* Logo */}
          <a
            href="#top"
            className="font-(family-name:--font-display) text-2xl font-semibold text-[var(--text-0)]"
        ...
        {/* Divider */}
        <div className="my-8 h-px w-full bg-[var(--surface-border)]" />
