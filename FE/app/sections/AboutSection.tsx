      ...
      <div className="mx-auto w-full max-w-[1920px] px-6 lg:px-12 xl:px-16 relative z-10">
        <div className="flex flex-col items-center text-center">
          ...
          <motion.h2 
            ...
            custom={0.1}
            className="font-(family-name:--font-display) text-[32px] sm:text-[40px] lg:text-[48px] font-bold text-[var(--text-0)] uppercase leading-tight tracking-wide"
          >
          ...
          >
            <a 
              href="#contact" 
              className="inline-block text-[#d5af34] font-bold text-sm sm:text-base tracking-[0.15em] uppercase border-b-2 border-[#d5af34] pb-1 hover:text-[var(--text-0)] hover:border-[var(--text-0)] transition-all duration-300"
            >
              Bắt đầu hành trình
            </a>
          </motion.div>
