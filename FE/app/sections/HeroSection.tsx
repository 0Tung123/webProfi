      ...
      <div className="mx-auto flex w-full max-w-[1920px] flex-col lg:flex-row items-center justify-between px-6 lg:px-12 xl:px-16 relative z-10">
        ...
        <div className="w-full lg:w-[50%] flex flex-col justify-center">
          ...
          <motion.h1
            ...
            animate="show"
            custom={0.2}
            className="font-(family-name:--font-display) text-[48px] sm:text-[64px] lg:text-[80px] xl:text-[96px] font-bold leading-[1.05] tracking-tight text-[var(--text-0)] uppercase"
          >
            ĐỊNH HÌNH <br />
          ...
          >
            <a 
              href="#contact" 
              className="group inline-flex items-center justify-center gap-3 rounded-full border border-[var(--surface-border)] bg-[var(--surface)] px-10 py-5 text-sm font-semibold uppercase tracking-[0.2em] text-[var(--text-0)] transition-all hover:bg-[rgba(0,0,0,0.05)] hover:border-[rgba(0,0,0,0.1)] backdrop-blur-sm"
        ...
        <div className="w-full lg:w-[50%] h-[400px] lg:h-[550px] mt-16 lg:mt-0 relative flex items-center justify-center">
          ...
          <motion.div 
            ...
            className="relative z-10 h-[300px] w-[90%] sm:h-[400px] sm:w-[600px] lg:h-[450px] lg:w-[650px] overflow-hidden rounded-2xl shadow-2xl bg-[var(--surface)]"
          >
            <img 
              src={cards[0].src} 
              alt={cards[0].alt}
          ...
          <motion.div 
            ...
            className="absolute z-20 -right-4 top-10 sm:right-0 sm:top-16 lg:-right-10 lg:top-24 h-[120px] w-[180px] sm:h-[180px] sm:w-[280px] overflow-hidden rounded-xl border-2 border-[#d5af34] shadow-[0_20px_40px_rgba(0,0,0,0.5)] bg-[var(--surface)]"
          >
            <img 
              src={cards[2].src} 
              alt={cards[2].alt}
          ...
          <motion.div 
            ...
            className="absolute z-20 -left-4 bottom-10 sm:left-4 sm:bottom-20 lg:-left-16 lg:bottom-32 h-[120px] w-[180px] sm:h-[180px] sm:w-[280px] overflow-hidden rounded-xl border-2 border-[#d5af34] shadow-[0_20px_40px_rgba(0,0,0,0.5)] bg-[var(--surface)]"
          >
            <img 
              src={cards[1].src} 
              alt={cards[1].alt}
